...
async function handler(req, res) {
    if (req.method === "POST") {
        ...
        const client = await external_mongodb_namespaceObject.MongoClient.connect("mongodb+srv://hugodubled:VNuHdvlg1mvABOjy@cluster0.89odw.mongodb.net/meetups?retryWrites=true&w=majority&appName=Cluster0");
        const db = client.db();
